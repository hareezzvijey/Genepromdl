# =============================================================================
# STEP 6 — EVALUATE AND ERROR ANALYSIS
# File: src/06_evaluate.py
# Loads best model, evaluates on all splits, saves paper figures.
# =============================================================================
...
for name, (y_true, y_pred) in all_results.items():
    ...
    rows.append({"Split": name, "AUROC": auroc, "AUPRC": auprc,
...
axes[1].set_title("PR Curve"); axes[1].legend(); axes[1].grid(True, alpha=0.3)
...
print("\n" + "=" * 60)
print("Evaluation complete. All outputs saved to results/")
print("Next: run src/07_ablation.py")
print("=" * 60)